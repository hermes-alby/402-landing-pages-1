...
title: "Instagram Profiles Download API · Hermes"
description: "Download Instagram public profiles on demand via Hermes-enabled pay-per-call access. No subscription, no API key, agent-native."
bodyClass: "page-instagram-profiles-hermes"
themeColor: "#262626"
ogTitle: "Instagram Profiles Download API — Hermes"
ogDescription: "Hermes-enabled pay-per-call access to Instagram public profile downloads and metadata retrieval. Built for marketing teams and AI agents."
schema:
  name: "Instagram Profiles Download API — Hermes"
  description: "Pay-per-call gateway for on-demand Instagram public profile downloads and metadata retrieval with Hermes support."
  mainEntityName: "Instagram Profiles Download API"
  mainEntityDescription: "On-demand Instagram profile download API with Hermes support for agent workflows."
  providerName: "Locus"
hero:
  ghostNumber: "Instant"
  eyebrow: "Pay-per-call · Hermes-ready · Agent-native"
  title:
    lines:
      - "Download Instagram"
      - "profiles on demand."
    highlight: "With Hermes integration."
  lead: "Fetch public Instagram profile metadata, photos, recent posts, follower counts, and media references in one request, using Hermes-ready pay-per-call access. No monthly plan, no API key, no backend credential store. Built for anybody that needs profile data on demand."
  meta:
    - "Public Instagram profile downloads"
    - "Hermes-ready pay-per-call"
    - "MCP native for agents"
    - "Fast profile metadata, posts, and media references"
  connection:
    agent:
      eyebrow: "Your Hermes agent"
      logo: "Logo"
      title: "Hermes-ready agent"
    service:
      eyebrow: "Instagram"
...
trust:
  items:
    - label: "Hermes support"
      stat: "Native"
      statHighlight: "integration"
      desc: "Built for agents using Hermes discovery and payment flows."
...
useCases:
  ...
  description: "Four use cases for anyone who benefits from Hermes-enabled on-demand profile downloads."
  items:
    ...
    - who: "For Hermes agents"
      title: "Use Instagram profile data as a tool call."
      text: "Autonomous Hermes agents can find the endpoint, pay per request, and enrich recommendations with current public Instagram profile data without manual credential management."
...
faq:
  ...
  items:
    ...
    - question: "Can Hermes agents call this without human setup?"
      answer: "Yes. The endpoint supports Hermes-compatible agent discovery and payment, so an autonomous agent can find the service, request a profile download, and continue without manual credential management."
